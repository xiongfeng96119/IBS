...
/**
 * (Stockincomebillitem)Query实体类-高级查询
 *
 * @author 吴昌勇
 * @since 2019-11-20 14:25:58
 */
public class StockincomebillitemQuery extends BaseQuery<Stockincomebillitem> {
     ...
     * @return
     */
    public Specification<Stockincomebillitem> getSpecification(){
        return Specifications.<Stockincomebillitem>and()
