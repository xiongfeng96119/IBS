...
/**
 * (Systemdictionarydetail)Query实体类-高级查询
 *
 * @author 吴昌勇
 * @since 2019-11-15 10:21:09
 */
public class SystemdictionarydetailQuery extends BaseQuery<Systemdictionarydetail> {
     ...
     * @return
     */
    public Specification<Systemdictionarydetail> getSpecification(){
        return Specifications.<Systemdictionarydetail>and()
