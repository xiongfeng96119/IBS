...
<html>
	...
	<body>
		...
		<div id="dd" class="easyui-dialog" title="新增/编辑Permission信息" style="width:400px;height:250px;"   
			...
			<form id="menu">
				...
				<div class="form-group">
					<input type="text" class="easyui-combobox form-control" name="menu.id" id="menuId" style="width: 204.5px"
						   data-options="url:'/menu/findAllChildren',valueField:'id',textField:'name',prompt:'请选择菜单',editable:false"/>
				</div>
				<div class="form-group">
