...
<html>
	<head>
		...
		<script type="text/javascript" src="/js/depot/depot.js"></script>
	</head>
	<body>
		<table id="dg"></table>
		<div id="toolbar">
		...
		<div id="dd" class="easyui-dialog" title="新增/编辑depot信息" style="width:400px;height:250px;"   
			...
			<form id="ffff">
				...
				<div class="form-group">
					<input type="text" class="easyui-validatebox form-control" name="name"
					   placeholder="name" data-options="" />
				</div>
				<div class="form-group">
					<input type="text" class="easyui-validatebox form-control" name="maxcapacity"
					   placeholder="maxcapacity" data-options="" />
				</div>
				<div class="form-group">
					<input type="text" class="easyui-validatebox form-control" name="currentcapacity"
					   placeholder="currentcapacity" data-options="" />
				</div>
				<div class="form-group">
					<input type="text" class="easyui-validatebox form-control" name="totalamount"
					   placeholder="totalamount" data-options="" />
				</div>
				<div class="form-group">
