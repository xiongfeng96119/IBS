...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Stockincomebillitem列表</title>
		<%@include file="/WEB-INF/views/common.jsp"%>
		<script type="text/javascript" src="/js/stockincomebillitem/stockincomebillitem.js"></script>
	</head>
	<body>
		<table id="dg"></table>
		<div id="toolbar">
		...
		<div id="dd" class="easyui-dialog" title="新增/编辑stockincomebillitem信息" style="width:400px;height:250px;"   
		        data-options="iconCls:'icon-save',resizable:false,modal:true,closed:true">   
			<form id="ffff">
				<input type="hidden" name="id" id="stockincomebillitemid" />
				...
				<div class="form-group">
					<input type="text" class="easyui-validatebox form-control" name="descs"
					   placeholder="descs" data-options="" />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<input type="text" class="easyui-validatebox form-control" name="billId"
					   placeholder="billId" data-options="" />
				</div>
				<div class="form-group">
