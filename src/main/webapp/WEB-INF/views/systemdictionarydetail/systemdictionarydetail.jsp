...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Systemdictionarydetail列表</title>
		<%@include file="../common.jsp"%>
		<script type="text/javascript" src="/js/systemdictionarydetail/systemdictionarydetail.js"></script>
	</head>
	<body>
		<table id="dg"></table>
		<div id="toolbar">
		...
		<div id="dd" class="easyui-dialog" title="新增/编辑Systemdictionarydetail信息" style="width:400px;height:250px;"   
		        data-options="iconCls:'icon-save',resizable:false,modal:true,closed:true">   
			<form id="menu">
				<input type="hidden" name="id" id="systemdictionarydetailid" />
				<div class="form-group">
					<input type="text" class="easyui-validatebox form-control" name="name"
						   placeholder="name"/>
				</div>
				<div class="form-group">
					<input type="text" class="easyui-combobox form-control" name="types.id" id="typesId" style="width: 204.5px"
						   data-options="url:'/systemdictionarytype/findAll',valueField:'id',textField:'name',prompt:'请选择类型',editable:false"/>
				</div>
				<div class="form-group">
