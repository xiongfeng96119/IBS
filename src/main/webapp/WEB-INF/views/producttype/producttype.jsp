...
<html>
	...
	<body>
		...
		<div id="dd" class="easyui-dialog" title="新增/编辑商品类型信息" style="width:400px;height:180px;"
			...
			<form id="ffff">
				...
				<div class="form-group">
					<input type="text" class="easyui-validatebox form-control" name="name"
					   placeholder="类型名称" data-options="" />
				</div>
				<div class="form-group">
					<input type="text" class="easyui-combobox form-control" name="parent.id"
					   id="parentId" data-options="" />
				</div>
				<div class="form-group">
